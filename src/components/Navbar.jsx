  ...
  return (
    <div className='bg-white flex text-black justify-between items-center h-24  max-w-[1240px] mx-auto px-4'>
        ...
        <ul className='hidden md:flex'>
            ...
            <li className='p-4 hover:text-[#fcb900]'><Button><ScrollLink to={"contact"} spy={true} smooth={true} offset={50} duration={500}>Contact</ScrollLink></Button></li>
        </ul>
        {/* <ul className='hidden md:flex'>
        ...
        <div className={nav ? "fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-white ease-in-out duration-500" : "fixed left-[-100%]"}>
            ...
            <ul className=''>
                <li className='p-4 border-b border-gray-600 hover:text-[#fcb900]'>Home</li>
                <li className='p-4 border-b border-gray-600 hover:text-[#fcb900]'>About</li>
                <li className='p-4 border-b border-gray-600 hover:text-[#fcb900]'>Donate</li>
                <li className='p-4 border-b border-gray-600 hover:text-[#fcb900]'>Discover</li>
